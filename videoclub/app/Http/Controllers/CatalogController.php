...
class CatalogController extends Controller
{
    ...
    {
        $peliculas = Movie::all(); // Obtiene todas las películas
        return view('catalog.index', compact('peliculas'));
    }

    public function getShow($id)
    {
        $pelicula = Movie::findOrFail($id); // Encuentra la película o lanza un error 404
    ...
    {
        $pelicula = Movie::findOrFail($id); // Encuentra la película
    ...
    Alert::success('Exito', 'La pelicula se ha guardado correctamente');

    // Redirigir al catálogo
    return redirect()->route('catalog.index')->with('success', 'Película creada correctamente');
}
...
public function putEdit(Request $request, $id)
{
    ...
    Alert::success('Exito', 'La pelicula se ha modificado correctamente');

    // Redirigir al detalle de la película
    return redirect()->route('catalog.show', $pelicula->id)->with('success', 'Película actualizada correctamente');
}
...
public function putRent($id){
    ...
    alert()->success('Exito', 'Has alquilado la pelicula correctamente');
	return redirect()->route('catalog.show', $id)->with('success', 'Película alquilada correctamente');
}
...
public function putReturn($id){
    ...
    alert()->success('Exito', 'Has devuelto la pelicula correctamente');
	return redirect()->route('catalog.show', $id)->with('success', 'Película devuelta correctamente');
...
alert()->success('Exito', 'La pelicula se ha eliminado correctamente');
